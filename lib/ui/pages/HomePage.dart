              ...
              children: [
                ...
                FutureBuilder<List<ProductSearch>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    final List<ProductSearch> allPromoProducts = snapshot.data!.take(5).toList();
                    ...
                    return Column(
                      children: allPromoProducts.map((product) {
                        ...
                        return _buildProductCard(
                          product.name,
                          firstPrice != null ? "${firstPrice.pricePromo.toInt()} FCFA" : "Prix indisponible",
                          isPromo: true,
    ...
    return Consumer<UserProvider>(
      builder: (context, userProvider, _) {
        ...
        return Scaffold(
          backgroundColor: AppColors.surface,
          appBar: _buildAppBar(),
          // <-- MODIFICATION WEB 1 : On centre tout et on limite la largeur à 800px maximum
          body: Center(
    ...
    return AppBar(
      ...
      title: Row(
        children: [
          ...
          Expanded(
            // <-- MODIFICATION WEB 2 : On limite la taille de la barre de recherche à 500px max
            child: Center(
              child: ConstrainedBox(
